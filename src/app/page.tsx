...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden">
        ...
        <div className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto w-full">
          ...
          <div className="flex items-center gap-6">
            ...
            {hasSession ? (
              <Link
                href="/workspace"
                className="px-6 py-2.5 rounded-xl text-sm font-bold bg-[var(--cyan)] hover:shadow-[0_0_24px_rgba(0,229,255,0.35)] transition-all"
                style={{ color: "#0a0e17" }}
              >
                进入工作台
              </Link>
      ...
      {/* Divider */}
      <div className="relative z-10 max-w-xs mx-auto py-4">
        <div className="h-px bg-gradient-to-r from-transparent via-[var(--cyan)]/20 to-transparent" />
      </div>

      {/* How it works */}
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-24">
        <h2 className="font-mono text-2xl font-bold text-center mb-16 text-[var(--text-primary)]">
          工作流程
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {workflowSteps.map((step, i) => (
            <div
              key={step.step}
              className="space-card rounded-xl p-6 text-center group hover:border-[var(--cyan)]/30 transition-all"
            >
      ...
      {/* Divider */}
      <div className="relative z-10 max-w-xs mx-auto py-4">
        <div className="h-px bg-gradient-to-r from-transparent via-[var(--nebula)]/20 to-transparent" />
      </div>
      ...
      {/* Divider */}
      <div className="relative z-10 max-w-xs mx-auto py-4">
        <div className="h-px bg-gradient-to-r from-transparent via-[var(--star)]/20 to-transparent" />
      </div>

      {/* CTA */}
      <section className="relative z-10 max-w-3xl mx-auto px-8 py-24 text-center">
        <div className="space-card rounded-2xl p-12">
          <h2 className="font-mono text-2xl font-bold mb-6 text-[var(--text-primary)]">
            开始你的创作
          </h2>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-10 py-4 rounded-xl text-base font-bold bg-[var(--cyan)] hover:shadow-[0_0_32px_rgba(0,229,255,0.4)] transition-all"
            style={{ color: "#0a0e17" }}
          >
      ...
      <footer className="relative z-10 border-t border-white/[0.04] py-10 mt-auto">
        <div className="max-w-5xl mx-auto px-8 flex items-center justify-between text-xs text-muted-foreground">
